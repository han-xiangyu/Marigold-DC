...
def main():
    ...
    # ---- Hardcoded folders ----
    INPUT_IMAGE_FOLDER = "/lustre/fsw/portfolios/nvr/users/ymingli/gaussian/data/spatial05_frames6000_with_multi_frame_depth/images"
    INPUT_DEPTH_FOLDER = "/lustre/fsw/portfolios/nvr/users/ymingli/gaussian/data/spatial05_frames6000_with_multi_frame_depth/depth_map_gt"
    OUTPUT_DEPTH_FOLDER = "/lustre/fsw/portfolios/nvr/users/ymingli/gaussian/data/spatial05_frames6000_with_multi_frame_depth/depth_map_marigold"
    OUTPUT_VIS_FOLDER = "/lustre/fsw/portfolios/nvr/users/ymingli/gaussian/data/spatial05_frames6000_with_multi_frame_depth/depth_map_marigold_vis"
    ...
    pipe = MarigoldDepthCompletionPipeline.from_pretrained(CHECKPOINT, prediction_type="depth").to(device)
    ...
    # ---- Match files and run inference ----
    rgb_images = sorted([f for f in os.listdir(INPUT_IMAGE_FOLDER) if f.endswith(".jpg")])
